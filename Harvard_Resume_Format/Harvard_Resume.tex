...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=black,
    pdftitle={Han Deok Lee's Resume},
...
\vspace*{-9pt}
\begin{center}
	{\Huge \scshape {Han Deok Lee}}\\
	\vspace{1mm}
	India $\cdot$ \underline{cyber93@gmail.com} $\cdot$ +82 10-5542-1453 $\cdot$ \href{https://github.com/cyber93}{\underline{Github}} $\cdot$ \href{https://www.linkedin.com/in/han-deok-lee-696437349/}{\underline{Linkedin}} \\
\end{center}
%==== Education ====%
\vspace{-2mm}
\header{Education}
...
\header{Publications}
\vspace{-0.5mm}
\textbf{Regulating I/O Performance of Shared Storage with a Control Theoretical Approach}
    {\textit{Han Deok Lee, Young Jin Nam, Kyong Jo Jung, Seok Gan Jung, Chanik Park}}\\
\vspace{0.5 mm}
Pre-Print Link:https: \url{https://doi.org/10.36227/techrxiv.24448963.v1} \\
Under Review IEEE Sensors Journal\\
12th NASA Goddard / 21st IEEE (MSST2004) Conference on Mass Storage Systems and Technologies \\
% \vspace{0.5 mm}
