...
\patchcmd{\ps@customFooterStyle}{\thepage}{
	\color{gray}\textit{\small Han Deok Lee - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
	...
	\begin{header}
		...
		\normalsize
		\mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Seoul, Korea}%
		\kern 0.25 cm%
		\AND%
		\kern 0.25 cm%
		\mbox{\hrefWithoutArrow{mailto:cyber93@gmail.com}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}cyber93@gmail.com}}%
		\kern 0.25 cm%
		\AND%
		\kern 0.25 cm%
		\mbox{\hrefWithoutArrow{tel:+82-10-5542-1453}{{\footnotesize\faPhone*}\hspace*{0.13cm}+82-10-5542-1453}}%
		\kern 0.25 cm%
		\AND%
		\kern 0.25 cm%
		\mbox{\hrefWithoutArrow{https://cyber93.github.io/}{{\footnotesize\faLink}\hspace*{0.13cm}cyber93.github.io}}%
		\kern 0.25 cm%
		\AND%
		\kern 0.25 cm%
		\mbox{\hrefWithoutArrow{https://linkedin.com/in/yourusername}{{\footnotesize\faLinkedinIn}\hspace*{0.13cm}Han Deok Lee}}%
		\kern 0.25 cm%
		\AND%
		\kern 0.25 cm%
		\mbox{\hrefWithoutArrow{https://github.com/cyber93}{{\footnotesize\faGithub}\hspace*{0.13cm}cyber93}}%
	\end{header}
